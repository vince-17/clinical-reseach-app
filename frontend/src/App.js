        ...
        <main className="content">
          <div className="container">
            ...
            <Routes>
              ...
              <Route path="/patients" element={<PatientsPage patients={patients} patientQuery={patientQuery} setPatientQuery={setPatientQuery} form={form} setForm={setForm} addPatient={addPatient} updatePatient={updatePatient} deletePatient={deletePatient} onDeleteConfirm={async (id)=>{ if (confirm('Delete this patient? This cannot be undone.')) { await deletePatient(id); setToast({ message: 'Patient deleted', type: 'success' }); } }} />} />
