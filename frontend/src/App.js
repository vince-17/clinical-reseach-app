        ...
        <main className="content">
          <div className="container">
            ...
            <Routes>
              ...
              <Route path="/patients" element={<PatientsPage patients={patients} patientQuery={patientQuery} setPatientQuery={setPatientQuery} form={form} setForm={setForm} addPatient={addPatient} updatePatient={updatePatient} deletePatient={deletePatient} onDeleteConfirm={async (id)=>{ if (confirm('Delete this patient? This cannot be undone.')) { await deletePatient(id); setToast({ message: 'Patient deleted', type: 'success' }); } }} loading={loading} />} />
              ...
              <Route path="/inventory" element={<InventoryPage items={items} newItem={newItem} setNewItem={setNewItem} addItem={addItem} updateItem={updateItem} lots={lots} newLot={newLot} setNewLot={setNewLot} loadLots={loadLots} addLot={addLot} dispense={dispense} setDispense={setDispense} doDispense={doDispense} patients={patients} loading={loading} itemQuery={itemQuery} setItemQuery={setItemQuery} />} />
